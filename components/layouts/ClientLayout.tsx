          ...
          <div className="flex items-center">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-72">
                ...
                <DropdownMenuItem asChild>
                  <Link href="/client/notifications" className="w-full justify-center text-center cursor-pointer">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem asChild>
                  <Link href="/client/profile" className="flex cursor-pointer">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right text-white/60 text-sm">
              ...
              <p>
                <Link href="/privacy-policy" className="text-rise-gold hover:underline">Privacy Policy</Link>
                {' • '}
                <Link href="/terms-of-service" className="text-rise-gold hover:underline">Terms of Service</Link>
              </p>
            </div>
          </div>
        </div>
