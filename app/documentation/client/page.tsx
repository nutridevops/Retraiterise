...
export default function ClientDocumentationPage() {
  ...
  useEffect(() => {
    ...
    const fetchContent = async () => {
      try {
        const response = await fetch('/documentation/client/guide-utilisateur.md');
        if (!response.ok) {
      ...
      <div className="container mx-auto px-4">
        <div className="mb-6 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link href="/client/dashboard" className="px-4 py-2 bg-[#0A291C] text-white rounded hover:bg-[#153e2c]">
              Retour au Dashboard
            </Link>
