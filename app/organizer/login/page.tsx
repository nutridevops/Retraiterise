        ...
        <Card className="w-full max-w-md shadow-lg">
          ...
          <CardContent>
            <Alert variant="destructive" className="mb-4">
              ...
              <AlertDescription>
                Votre compte n'a pas les permissions nécessaires pour accéder au portail organisateur.
              </AlertDescription>
            </Alert>
          </CardContent>
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 p-4">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg font-medium">Redirection vers le tableau de bord...</p>
        </div>
      </div>
    );
  }
