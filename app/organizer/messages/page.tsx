...
import { PenSquare, Inbox, Users, Loader2 } from 'lucide-react';
...
export default function OrganizerMessagesPage() {
  ...
  const fetchClients = async () => {
    try {
      ...
      toast({
        title: 'Erreur',
        description: error.message || "Une erreur s'est produite lors du chargement des clients.",
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
                ...
                <TabsContent value="inbox" className="mt-0">
                  <Card>
                    <CardHeader className="pb-3">
                      ...
                      <CardDescription>
                        Consultez vos messages et communiquez avec les clients de la retraite.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <MessageList
              ...
              <div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Envoyez un message aux clients de la retraite.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <MessageComposer
